...
| 工作流模型 | 以 issue label 为主驱动，agent 通过 `gh issue edit` 推进状态 | `internal/statemachine/statemachine.go`, `.github/workbuddy/workflows/*.md` |
...
| 文档 | 说明 | 主要代码 |
| --- | --- | --- |
| `docs/implemented/current-architecture.md` | 当前系统形态、主链路和 CLI 入口 | `cmd/serve.go`, `internal/router/router.go`, `internal/statemachine/statemachine.go` |
