...
| `workbuddy issue restart` | 清除 issue cache / dependency state / issue claim / cycle state；若 coordinator 可达则同时清掉进程内 inflight tracker（`admin restart-issue` 为 deprecated alias） | REQ-060, 061, 114 | v0.2.0 |
