...
func (s *dbStore) IssueWorkerToken(workerID, repo string, roles []string, hostname string) (*IssuedWorkerToken, error) {
...
func (s *dbStore) ListWorkerTokens(repo string) ([]WorkerTokenRecord, error) {
	var (
		rows *sql.Rows
		err  error
	)
...
func (s *dbStore) RevokeWorkerToken(workerID, kid string) error {
...
func (s *dbStore) AuthenticateWorkerToken(token string) (*WorkerAuthRecord, error) {
